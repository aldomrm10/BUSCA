...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "aiokmojcur70g-ats.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "My_iot_thing" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "My_iot_thing" ///< Thing Name of the Shadow this device is associated with

#define AWS_IOT_ROOT_CA_FILENAME       "/cert/sf-class2-root.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "/cert/4f6bbb14f2-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "/cert/4f6bbb14f2-private.pem.key" ///< Device private key filename
// =================================================
